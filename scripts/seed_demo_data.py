...
def main():
    ...
    diagnosticos = [
        ...
        # Pedro Henrique — fogo, propósito
        {
            ...
            "setenio_atual": 4,
            "florais_prescritos": ["Impatiens", "Holly", "Oak"],
            "protocolo_texto": "Canalizar energia do Fogo: exercício físico intenso 3x/semana. Respiração do dragão nos momentos de irritação. Diário de propósito — anotar 1 coisa que fez sentido no dia.",
        ...
        # Juliana — trauma, terra, família
        {
            ...
            "setenio_atual": 6,
            "florais_prescritos": ["Star of Bethlehem", "Pine", "Crab Apple", "Walnut", "Chicory"],
            "protocolo_texto": "Trabalho de re-parentalização: carta à criança interior 1x/semana. Florais para trauma (Star of Bethlehem) e culpa (Pine). Exercício de separação eu/mãe. Limites amorosos com família.",
        ...
        },
        {
            ...
            "setenio_atual": 6,
            "florais_prescritos": ["Star of Bethlehem", "Walnut", "Larch", "Gentian"],
            "protocolo_texto": "Evolução positiva. Ajuste de florais: retirar Pine (culpa processada), adicionar Larch (autoconfiança) e Gentian (fé no processo). Manter re-parentalização. Iniciar trabalho com Fogo — vontade própria.",
        ...
        # Marcos — ar, relacionamento, novo
        {
            ...
            "setenio_atual": 5,
            "florais_prescritos": ["Holly", "Walnut", "Clematis"],
            "protocolo_texto": "Paciente novo, avaliação inicial. Elemento Ar dominante com dispersão mental. Trabalho inicial de aterramento. Florais para ciúme (Holly) e transição (Walnut). Próxima sessão aprofundar ferida de Traição.",
        ...
        # Beatriz — fogo, autoestima, astrologia
        {
            ...
            "setenio_atual": 4,
            "florais_prescritos": ["Larch", "Crab Apple", "Pine", "Willow"],
            "protocolo_texto": "Espelho Distorcido identificado — Mercúrio turvo. Exercício do espelho diário (30 seg olhando nos olhos + afirmação). Florais para autoconfiança (Larch) e autopurificação (Crab Apple). Análise do mapa natal como ferramenta.",
        ...
        },
        {
            ...
            "setenio_atual": 4,
            "florais_prescritos": ["Larch", "Walnut", "Gentian"],
            "protocolo_texto": "Melhora na autoestima após 3 semanas de exercício do espelho. Ajuste: retirar Crab Apple e Pine (processados). Foco em Walnut para fortalecer identidade própria e não se comparar.",
        ...
        # Rafael — água, meditação, autoconhecimento
        {
            ...
            "setenio_atual": 5,
            "florais_prescritos": ["Clematis", "Wild Oat", "Olive", "Walnut"],
            "protocolo_texto": "Meditação como Athanor: prática diária de 5 min com contagem de respirações. Florais para foco (Clematis) e propósito (Wild Oat). Questão existencial do Retorno de Saturno em trabalho.",
        ...
        # Camila — terra, ansiedade, florais
        {
            ...
            "setenio_atual": 4,
            "florais_prescritos": ["Mimulus", "Rescue", "Agrimony", "Elm"],
            "protocolo_texto": "Ansiedade com componente de vergonha social. Terra dominante traz rigidez — dificuldade de se expressar (Ar carente). Florais para medo conhecido (Mimulus) e máscara social (Agrimony). Exercícios de comunicação autêntica.",
        ...
        # Lucas Gabriel — água, depressão
        {
            ...
            "setenio_atual": 3,
            "florais_prescritos": ["Mustard", "Olive", "Gorse", "Sweet Chestnut"],
            "protocolo_texto": "Nigredo ativa — fase depressiva. Autocuidado prioritário: sol 15min/dia, água 2L, caminhada curta. Florais para depressão sem causa (Mustard) e exaustão (Olive). Manter acompanhamento presencial com psicólogo.",
        ...
        },
        {
            ...
            "serpentes_ativas": ["Tristeza", "Medo"],
            "setenio_atual": 3,
            "florais_prescritos": ["Mustard", "Hornbeam", "Larch", "Walnut"],
            "protocolo_texto": "Melhora sutil no humor. Troca de Olive por Hornbeam (motivação matinal). Adição de Larch para autoestima. Manter protocolos de autocuidado. Incentivar pequenas conquistas diárias.",
        ...
        # Fernanda — ar, astrologia, mapa natal
        {
            ...
            "setenio_atual": 5,
            "florais_prescritos": ["Cerato", "Walnut", "Clematis", "Rock Rose"],
            "protocolo_texto": "Ar em excesso: muita análise, pouca ação. Aterramento via elemento Terra essencial. Exercícios de materialização: escolher 1 insight por semana e colocar em prática. Florais para confiança na intuição (Cerato).",
        ...
        },
        {
            ...
            "setenio_atual": 5,
            "florais_prescritos": ["Walnut", "Clematis", "Elm", "Oak"],
            "protocolo_texto": "Evolução significativa. Ar mais equilibrado com práticas de aterramento. Padrão de se perder em relacionamentos sendo trabalhado — margem alquímica. Ajuste de florais: Elm para sobrecarga e Oak para resiliência.",
        ...
        # Thiago — fogo, família, novo
        {
            ...
            "setenio_atual": 4,
            "florais_prescritos": ["Holly", "Impatiens", "Vine"],
            "protocolo_texto": "Avaliação inicial. Fogo intenso com conflitos familiares — relação com pai (Sol eclipsado). Respiração do dragão para momentos de raiva. Florais para raiva (Holly) e impaciência (Impatiens). Início do processo de individuação.",
